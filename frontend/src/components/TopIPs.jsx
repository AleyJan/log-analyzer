    ...
    <div className="card">
      <div className="card-header">
        <div className="card-title">
          <span className="card-title-icon">◉</span>TOP_IPS
        </div>
      ...
      <table className="log-table">
        ...
        <tbody>
          {pageData.map((row, i) => (
            <tr key={i}>
              <td style={{ color: "var(--text-4)", fontSize: "0.65rem" }}>
              ...
              <td>
                <span className={`badge ${errClass(row.errorRate)}`}>
                  {row.errorRate}%
                </span>
              </td>
            </tr>
